...
import tasks.errorhandling.Exceptions;
...
public class TaskIO {
    ...
    public static void writeBinary(TaskList tasks, File file) throws IOException, Exceptions {
        try (FileOutputStream fos = new FileOutputStream(file)) {
            write(tasks, fos);
        } catch (IOException e) {
            log.error("IO exception reading or writing file");
            throw new Exceptions("IO exception reading or writing file");
        }
    }

    public static void readBinary(TaskList tasks, File file) throws IOException, Exceptions {
    ...
    public static void read(TaskList tasks, Reader in) throws IOException, Exceptions {
    ...
    public static void writeText(TaskList tasks, File file) throws IOException, Exceptions {
    ...
    public static void readText(TaskList tasks, File file) throws IOException, Exceptions {
        try (FileReader fileReader = new FileReader(file)) {
            read(tasks, fileReader);
        }
    }
    //// service methods for reading
    private static Task getTaskFromString (String line) throws Exceptions {
    ...
    private static Date getDateFromText (String line, boolean isStartTime) throws Exceptions {
        Date date = null;
        ...
        try {
            ...
            throw new Exceptions("date parse exception");
        }
        return date;
    ...
    public static void rewriteFile(ObservableList<Task> tasksList) throws Exceptions {
